...
# When you run:  python3 cell_grid_service_v2.py
INPUT_PDF_RELATIVE_PATH = "test_pdf3.pdf"
OUTPUT_PDF_RELATIVE_PATH = "cell_grid_v2_pdf3.pdf"
        ...
        for r in range(1, rows + 1):
            ...
            for c in range(1, cols + 1):
                ...
                score, ink_ratio, blob_frac = _cell_metrics(
                    gray[y0_px:y1_px, x0_px:x1_px], ink_brightness_max=ink_brightness_max
                )
                if (
                    score >= min_score
...
if __name__ == "__main__":
    ...
    _runs = analyze_pdf_writable_runs(_bytes, dpi=150)
    draw_writable_runs_overlay(_bytes, _runs, _out)
    print(_out.resolve())
