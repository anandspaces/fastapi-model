...
# When you run:  python3 cell_grid_service_v3.py
INPUT_PDF_RELATIVE_PATH = "test_pdf3.pdf"
OUTPUT_PDF_RELATIVE_PATH = "cell_grid_v3_pdf3.pdf"
...
if __name__ == "__main__":
    ...
    _runs = analyze_pdf_writable_runs(_bytes, dpi=150, min_run_length=MIN_RUN_LENGTH)
